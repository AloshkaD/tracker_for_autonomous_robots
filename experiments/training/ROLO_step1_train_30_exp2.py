...
class ROLO_TF:
    ...
    rolo_weights_file = '/home/a/SDC/defence/weights/model_step1_exp2.ckpt'
    lstm_depth = 3
    ...
    def train_30_2(self):
        print("TRAINING ROLO...")
        log_file = open("/home/a/SDC/defence/output/trainging-step1-exp2.txt", "a") #open in append mode
        self.build_networks()
